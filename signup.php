...
<div id="content">
    ...
    <form id="form" class="largeform" action="signup.php" method="post">
        ...
        <fieldset>
            ...
            <input id="conferma" name="conferma" type="password" reqired/>
