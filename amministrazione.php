...
<body>
    ...
    <div id="content">
        ...
        <?php
            $prenotazioni=null;
            if(!GetPrenotazioni($prenotazioni)){
        ?>
        <h2><?php echo $areautentetext["riepilogo_prenotazioni"]?></h2>
        <ul class="prenotazioni_admin">
            <?php 
                ...
                foreach($prenotazioni as $prenotazione)
                {
                    ...
                    if(strtotime($prenotazione["data_"])>strtotime('now')){
                        echo "<a class='link_modifica' href='admin_modifica_prenotazione.php?id=".$prenotazione["id_prenotazione"]."' >".$areautentetext["modifica_prenotazioe"]."</a>";
                    }
                    echo "</li>";
                }
            ?>
