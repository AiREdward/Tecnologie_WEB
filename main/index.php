...
<body>
    ...
    <div id="content">
        <section id="stanza1" class="home_room">
            ...
            <a class="prenotazione_rapida" href="richiestaPrenotazione.php?room=1"><?php echo $roomstext["pulsante_prenota"]?></a>
        </section>
        <section id="stanza2" class="home_room">
            ...
            <a class="prenotazione_rapida" href="richiestaPrenotazione.php?room=2"><?php echo $roomstext["pulsante_prenota"]?></a>
        </section>
        <section id="stanza3" class="home_room">
            ...
            <a class="prenotazione_rapida" href="richiestaPrenotazione.php?room=3"><?php echo $roomstext["pulsante_prenota"]?></a>
        </section>
    </div>
</body>
</html>